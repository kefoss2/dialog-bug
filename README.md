...
2. Add a name for the app. Add 2 Redirect URIs of type "Single-page application (SPA)": `brk-multihub://localhost:3000` and `http://localhost:3000/taskpane.html`.
3. Click "Register".
...
1. Log into an email from the tenant with the app registration from the last section in OWA.
...
5. Open an email and open the apps menu. Click the "Dialog API Bug Demo" button. A dialog with 2 buttons, one to delete an email and one to cancel, should appear.
